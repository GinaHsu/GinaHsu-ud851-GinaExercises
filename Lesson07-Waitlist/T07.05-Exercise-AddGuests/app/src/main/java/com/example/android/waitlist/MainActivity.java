...
public class MainActivity extends AppCompatActivity {
    ...
    private EditText mNewGuessNameEditText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNewGuessNameEditText = (EditText) findViewById(R.id.person_name_edit_text);
        mNewPartySizeEditText =(EditText) findViewById(R.id.party_size_edit_text);
    ...
    public void addToWaitlist(View view) {
        ...
        if(mNewPartySizeEditText.getText().length() == 0 ||
                mNewGuessNameEditText.length() == 0){
            return;
        }
        ...
        mNewGuessNameEditText.getText().clear();
