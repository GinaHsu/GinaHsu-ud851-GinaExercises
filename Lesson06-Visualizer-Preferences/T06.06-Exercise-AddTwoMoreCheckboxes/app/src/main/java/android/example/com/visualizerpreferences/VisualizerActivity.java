...
import static android.example.com.visualizerpreferences.R.string.pref_show_treble_key;
...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void setupSharedPreferences() {
        ...
        mVisualizerView.setShowTreble(sharedPreferences.getBoolean(getString(pref_show_treble_key),
