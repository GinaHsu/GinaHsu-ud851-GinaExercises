...
public class MainActivity extends AppCompatActivity {
    ...
    private void displayBoardingPassInfo(BoardingPassInfo info) {
        ...
        long hourUntilBoarding = TimeUnit.MINUTES.toHours(totalMinUntilBoarding);
        long minLessHourUntilBoarding = totalMinUntilBoarding - TimeUnit.HOURS.toMinutes(hourUntilBoarding);

        String hourAndMinBoarding = getString(R.string.countDownFormat, hourUntilBoarding, minLessHourUntilBoarding);

        mBinding.textViewBoardingInCountdown.setText(hourAndMinBoarding);
    }
}
